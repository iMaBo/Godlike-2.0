...
public class data {
	...
	public static String Help = ChatColor.GOLD + "=" + ChatColor.GRAY + "="
			...
			+ " Godlike V2.0 " + ChatColor.GRAY + "=" + ChatColor.GOLD + "="
			+ ChatColor.GRAY + "=" + ChatColor.GOLD + "=";

	public static String Commands = ChatColor.GOLD
			+ "/godlike <sword|tools|bow|armor|fishing>";

	public static String noPlayer = ChatColor.RED
			+ "You must be a player to do this.";

	public static String noPermissions = ChatColor.RED
	...
	public String getItemName() {
		String messageItem = ChatColor.DARK_GRAY + "[" + ChatColor.GOLD + "X"
				+ ChatColor.DARK_GRAY + "]" + ChatColor.GOLD + " You`ve got a "
